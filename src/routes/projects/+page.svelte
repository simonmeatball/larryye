...
<div class="px-4 py-8 max-w-[70rem] mx-auto">
    ...
    {:else}
        <div class="fade-in">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <ProjectCard projectName="Prospectus" img="/ProspectusHomePage.png" description="A resume-sharing website built by me and my friends. Check out the code <a href='https://github.com/aroy23/Prospectus' class='underline hover:text-gray-300'>here</a> or watch our <a href='https://www.youtube.com/watch?v=dHh1mvhMxEE' class='underline hover:text-gray-300'>video presentation</a>!" />
                <ProjectCard projectName="IdeaHacks 2025 Website" img="/IdeaHacks2025.png" description="A website I helped work on for IdeaHacks 2025, the largest hardware hackathon on the west coast hosted by UCLA. Explore it for yourself at <a href='https://ideahacks.la/' class='underline hover:text-gray-300'>ideahacks.la</a>"/>
